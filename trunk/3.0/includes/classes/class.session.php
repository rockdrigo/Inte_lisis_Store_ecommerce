...
class ISC_SESSION
{
	...
	public function CreateSession()
	{
		...
		if($GLOBALS['ISC_CLASS_DB']->FetchOne('SELECT sessionhash FROM [|PREFIX|]sessions WHERE sessionhash = "'.$newSession['sessionhash'].'"', 'sessionhash')){
			$GLOBALS['ISC_CLASS_DB']->UpdateQuery('sessions', $newSession, 'sessionhash = "'.$newSession['sessionhash'].'"');			
		}
		else {
