...
class ISC_DATA_STORE_DISK
{
	...
	public function Save($name, $data)
	{
		...
		if(file_put_contents($this->baseDir.'/'.$name.'.php', $contents)) {
			//NES - Estos archivos tienen que ser escribibles por todos para que no hayan problemas con interfaces que crean categorias
			isc_chmod($this->baseDir.'/'.$name.'.php', ISC_TEMPLATE_FILE_PERM);
			return true;
		}
		else {
			return false;
