<?php
	...
	require_once(ISC_BASE_PATH . "/lib/lic.php");
	...
	*/
	...
	function logAddNotice($msg, $mod = 'php'){
		$GLOBALS['ISC_CLASS_LOG']->LogSystemNotice($mod, isc_substr($msg, 0, 250), $msg.= trace(false,true));
	}

	function logAddWarning($msg, $mod = 'php'){
		$GLOBALS['ISC_CLASS_LOG']->LogSystemWarning($mod, isc_substr($msg, 0, 250), $msg.= trace(false,true));
	}

	function logAddSuccess($msg, $mod = 'php'){
		$GLOBALS['ISC_CLASS_LOG']->LogSystemSuccess($mod, isc_substr($msg, 0, 250), $msg.= trace(false,true));
	}
	
	function logAddError($msg, $mod = 'php'){
		$GLOBALS['ISC_CLASS_LOG']->LogSystemError($mod, isc_substr($msg, 0, 250), $msg.= trace(false,true));
	}
