		...
		public function GetVariationOptions($customerGroupId = null)
		{
			...
			if(count($optionIdsArray) == $product['vnumoptions']) {
				...
				if(GetConfig('isIntelisis')){
					$productClassArray = $productClass->GetProduct();
					$productClassArray['prodcalculatedprice'] = $combinationDetails['unformattedPriceNoThou'];
					$newprice = applyPyC($productClassArray, 1, $combination['combinationid']);
