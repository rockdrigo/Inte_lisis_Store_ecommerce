...
class ISC_FORMFIELD_SINGLESELECT extends ISC_FORMFIELD_BASE
{
	...
	public function loadForFrontend()
	{
		...
		if(isset($this->extraInfo['extraHTML'])) {
			$GLOBALS['FormFieldDefaultArgs'] .= $this->extraInfo['extraHTML'];
		}
	...
	public function loadForBackend()
	{
		...
		if(isset($this->extraInfo['extraHTML'])) $GLOBALS['FormFieldExtraHTML'] = htmlentities($this->extraInfo['extraHTML']);
