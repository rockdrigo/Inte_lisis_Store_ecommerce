<?php
	...
	$GLOBALS['ISC_CFG']["StoreName"] = "Tienda Virtual";
	$GLOBALS['ISC_CFG']["StoreAddress"] = "Direccion";
	...
	$GLOBALS['ISC_CFG']["HomePopularProducts"] = 0;
	...
	$GLOBALS['ISC_CFG']["AdminEmail"] = "admin@ejemplo.com";
	$GLOBALS['ISC_CFG']["OrderEmail"] = "admin@ejemplo.com";
	...
	$GLOBALS['ISC_CFG']['StoreTimeZone'] = '-6';
	...
	$GLOBALS['ISC_CFG']['ShowMailingListInvite'] = 0;
	...
	$GLOBALS['ISC_CFG']['ShowPriceGuest'] = 1;
	...
	$GLOBALS['ISC_CFG']['ForwardInvoiceEmails'] = 'admin@ejemplo.com';
	...
	$GLOBALS['ISC_CFG']['UseStoreHours'] = "0";
	$GLOBALS['ISC_CFG']['StoreHoursFromHours'] = "0";
	$GLOBALS['ISC_CFG']['StoreHoursFromMinutes'] = "0";
	$GLOBALS['ISC_CFG']['StoreHoursToHours'] = "0";
	$GLOBALS['ISC_CFG']['StoreHoursToMinutes'] = "0";
	$GLOBALS['ISC_CFG']['StoreClosed'] = 0;
	
	// Extra fields on checkout for new orders
	$GLOBALS['ISC_CFG']['CheckoutUseExtraFields'] = 1;
	
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldActive1'] = 1;
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldName1'] = 'Requiere Factura?';
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldType1'] = 'checkbox';
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldValue1'] = '';
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldRequired1'] = 0;
	
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldActive2'] = "0"; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldName2'] = ""; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldType2'] = ""; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldValue5'] = '';
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldRequired2'] = "0";
	
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldActive3'] = "0"; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldName3'] = ""; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldType3'] = ""; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldValue5'] = '';
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldRequired3'] = "0";
	
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldActive4'] = "0"; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldName4'] = ""; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldType4'] = ""; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldValue5'] = '';
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldRequired4'] = "0";
	
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldActive5'] = "0"; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldName5'] = ""; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldType5'] = ""; 
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldValue5'] = '';
	$GLOBALS['ISC_CFG']['CheckoutExtraFieldRequired5'] = "0";
	
	$GLOBALS['ISC_CFG']['syncDropboxActive'] = 0;
	$GLOBALS['ISC_CFG']['syncDropboxOffline'] = 0;
	...
	$GLOBALS['ISC_CFG']['LicenseTypeControl'] = 2;
	
	$GLOBALS['ISC_CFG']['isIntelisis'] = 0;
	...
	$GLOBALS['ISC_CFG']['showDeliveryDateFromStatus'] = 0;
	$GLOBALS['ISC_CFG']['ignoreAddressID0'] = 1;
	
	$GLOBALS['ISC_CFG']['syncArchiveDir'] = '/home/sincro/Archivo/';
	
	$GLOBALS['ISC_CFG']['AccountCreationInactiveUsers'] = 0;
	
	$GLOBALS['ISC_CFG']['DisplayCheckBoxLimit'] = 30;
	
	$GLOBALS['ISC_CFG']['ForcePasswordChangeNewUsers'] = 0;