<?php
	...
	class ISC_CUSTOMER
	{
		...
		*/
		...
		public function getCustomerStoreOrigin(){
			return $GLOBALS['ISC_CLASS_DB']->FetchOne('SELECT Sucursal FROM [|PREFIX|]intelisis_customers WHERE customerid = "'.$this->GetCustomerId().'"', 'Sucursal');
		}
