...
class ISC_INTELISIS_ECOMMERCE_WEBSUCURSALIMAGEN extends ISC_INTELISIS_ECOMMERCE
{
	...
	private function moveImageFile(){
		...
		$temporaryPath = GetConfig('syncDropboxDir').$Clave.DIRECTORY_SEPARATOR.'Imagenes'.DIRECTORY_SEPARATOR.'Sucursal'.DIRECTORY_SEPARATOR.$this->getData('Nombre').$this->getData('TipoArchivo');
