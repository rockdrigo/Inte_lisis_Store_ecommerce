...
class ACCOUNTING_QUICKBOOKS_SERVICE_PREREQUISITEEDIT extends ACCOUNTING_QUICKBOOKS_SERVICE_BASE
{
	...
	{
		$this->accounting->unsetReference("prerequisite", $this->spool["nodeData"]);
		return $this->execChildService("prerequisite", "add", $this->spool["nodeData"]);
	}
