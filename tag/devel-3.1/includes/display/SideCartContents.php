...
CLASS ISC_SIDECARTCONTENTS_PANEL extends PANEL
{
	public function SetPanelSettings()
	{
		...
		foreach($items as $item) {
			...
			$GLOBALS['ProductCartPrice'] = currencyConvertFormatPrice($item->getTotal($incTax),null,null,true);
		...
		$GLOBALS['ISC_LANG']['SideCartTotalCost'] = sprintf(GetLang('SideCartTotalCost'), CurrencyConvertFormatPrice($total,$defaultCurrency,null,true));
