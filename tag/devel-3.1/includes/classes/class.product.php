		...
		*/
		public function GetCombinationDetails($combination, $customerGroupId = null)
		{
			...
			if($this->GetProductCallForPricingLabel()) {
				...
				$variationPrice = formatProductDetailsPrice($this->_product, $priceOptions, $GLOBALS['CurrentCurrency']);
			}
		...
		*/
		...
		static public function buildSearchResultsHTML()
		{
			...
			foreach ($results["results"] as $product) {
				...
				if (((GetConfig('ShowProductPrice') && !$product['prodhideprice']) && $custInfo != NULL) || ((GetConfig('ShowPriceGuest') && GetConfig('ShowProductPrice') && !$row['prodhideprice'] && $custInfo == NULL))) {
