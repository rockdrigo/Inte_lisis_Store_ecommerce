	...
	*/
	class ISC_SHIPPING extends ISC_MODULE
	{
		...
		*/
		...
		/**
		* @var integer The total volume of all products in the _products array in LBS
		*/
		protected $_volume = 0;
		...
		*/
		public function additem($weight, $length=0, $width=0, $height=0, $qty=1, $desc="",$cost=0)
		{
			...
			$this->_volume += ($new_product->getheight() * $new_product->getlength() * $new_product->getwidth() * $qty);
