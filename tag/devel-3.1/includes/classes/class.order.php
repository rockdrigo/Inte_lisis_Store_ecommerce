	...
	class ISC_ORDER
	{
		...
		*/
		private function ThanksForYourOrder()
		{
			...
			//NES: Agregado para generar el XML cuando se termina un pedido
			$resultXML = $GLOBALS['ISC_CLASS_DB']->Query('CALL [|PREFIX|]spSincronizacionPedidos("'.$order['orderid'].'", "'.$order['ordstatus'].'")');
