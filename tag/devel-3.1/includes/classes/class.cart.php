...
class ISC_CART
{
	...
	*/
	...
	private function _setupFastCartData($quote, $item)
	{
		...
		$prodTotal = CurrencyConvertFormatPrice($item->getTotal(),null,null,true);
		...
		$GLOBALS['fastCartSubtotal'] = CurrencyConvertFormatPrice($quote->getSubTotal(),$defaultCurrency,null,true);
	}
