				...
				<div id="div0" style="padding-top: 10px;">
					...
					<table width="100%" class="Panel">
						...
						<tr>
							...
							<td>
								<input type="checkbox" onclick="toggleCheckoutExtraFields();" name="CheckoutUseExtraFields" id="CheckoutUseExtraFields" value="1"{{ CheckoutUseExtraFieldsChecked|safe }}/> <label for="CheckoutUseExtraFields">{% lang 'CheckoutUseExtraFields' %}</label>
