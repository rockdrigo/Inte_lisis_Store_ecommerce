...
<tr>
			...
			<div id="div10" style="padding-top: 10px; display: none;">
				<table width="100%" class="Panel">
					...
					<tr>
						<td class="Heading2" colspan="2">Cotizaciones</td>
					</tr>
					<tr>
						<td class="FieldLabel">
							<label for="QuotationDays">Dias de vencimiento de cotizacion:</label>
						</td>
						<td>
							<input id="QuotationDays" name="QuotationDays" value="{{ QuotationDays }}" type="text" class="Field40" />
							<img onmouseout="HideHelp('hQuotationDays');" onmouseover="ShowHelp('hQuotationDays', 'Dias de vencimiento de cotizaciones', 'Dias de duracion de las cotizaciones')" src="images/help.gif" width="24" height="16" border="0" />
							<div style="display:none" id="hQuotationDays"></div>
						</td>
					</tr>
					<tr>
						<td class="Heading2" colspan="2">Autenticación</td>
					</tr>
						<tr>
						<td class="FieldLabel">
							<label for="AllPageAuth">Requerir autenticación para todas las páginas:</label>
						</td>
						<td>
							<input type="checkbox" name="AllPageAuth" id="AllPageAuth" value="ON" {{ AllPageAuthChecked|safe }} />
							<img onmouseout="HideHelp('hAllPageAuth');" onmouseover="ShowHelp('hAllPageAuth', 'Requerir autenticación para todas las páginas', 'Marcar la opción para requerir autenticación de usuarios para ver todas las páginas.')" src="images/help.gif" width="24" height="16" border="0" />
							<div style="display:none" id="hAllPageAuth"></div>
						</td>
					</tr>
