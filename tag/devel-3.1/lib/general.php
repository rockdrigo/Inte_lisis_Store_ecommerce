<?php
	...
	*/
	...
	function FormatVolume($volume, $includemeasure=false)
	{
		$num = number_format($volume, GetConfig('DimensionsDecimalPlaces'), GetConfig('DimensionsDecimalToken'), GetConfig('DimensionsThousandsToken'));

		if ($includemeasure) {
			$num .= " " . GetConfig('VolumeMeasurement');
		}
