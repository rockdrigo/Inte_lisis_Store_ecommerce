	...
	class ISC_ADMIN_PAGES extends ISC_ADMIN_BASE
	{
		...
		private function _BuildPageList($parentid=0, $sortField='', $sortOrder='', $depth=0, $vendorId=0)
		{
			...
			foreach($pagecache[$parentid] as $p) {
				...
				$GLOBALS['PageURL'] = PageLink($p['pageid'], $p['pagetitle']);
		...
		private function AddPageStep1($MsgDesc = "", $MsgStatus = "", $IsError = false)
		{
			...
			if($IsError) {
				...
				if(isset($_POST['pagecustomersonly'])) {
					$GLOBALS['PageCustomerOnlySelected1'] = $_POST['pagecustomersonly'];
				}
				
				//JIB REQ11481: A�adi los siguientes campos
				if(isset($_POST['contactfields']['names'])) {
					$GLOBALS['IsContactNames'] = 'checked="checked"';
				}
				
				if(isset($_POST['contactfields']['lastname'])) {
					$GLOBALS['IsContactLastName'] = 'checked="checked"';
				}
				
				if(isset($_POST['contactfields']['address'])) {
					$GLOBALS['IsContactAddress'] = 'checked="checked"';
				}
				
				if(isset($_POST['contactfields']['colony'])) {
					$GLOBALS['IsContactColony'] = 'checked="checked"';
				}
				
				if(isset($_POST['contactfields']['country'])) {
					$GLOBALS['IsContactCountry'] = 'checked="checked"';
				}
				
				if(isset($_POST['contactfields']['city'])) {
					$GLOBALS['IsContactCity'] = 'checked="checked"';
				}
				
				if(isset($_POST['contactfields']['zip'])) {
					$GLOBALS['IsContactZip'] = 'checked="checked"';
				}
				
				if(isset($_POST['contactfields']['birthday'])) {
					$GLOBALS['IsContactBirthday'] = 'checked="checked"';
				}
		...
		private function _GetPageData($PageId, &$RefArray)
		{
			if ($PageId == 0 && !empty($_POST)) {
				...
				if (isset($_POST['pagecustomersonly'])) {
					$RefArray['pagecustomersonly'] = $_POST['pagecustomersonly'];
				} else {
		...
		private function EditPageStep1($MsgDesc = "", $MsgStatus = "", $IsError = false)
		{
			...
			if(PageExists($pageId)) {
				...
				*/
				$GLOBALS['PageCustomerOnlySelected'.$arrData['pagecustomersonly']] = 'selected=selected';
				...
				if(is_numeric(isc_strpos($arrData['pagecontactfields'], "names"))) {
					$GLOBALS['IsContactNames'] = 'checked="checked"';
				}
				
				if(is_numeric(isc_strpos($arrData['pagecontactfields'], "lastname"))) {
					$GLOBALS['IsContactLastName'] = 'checked="checked"';
				}
				
				if(is_numeric(isc_strpos($arrData['pagecontactfields'], "address"))) {
					$GLOBALS['IsContactAddress'] = 'checked="checked"';
				}

				if(is_numeric(isc_strpos($arrData['pagecontactfields'], "colony"))) {
					$GLOBALS['IsContactColony'] = 'checked="checked"';
				}
				
				if(is_numeric(isc_strpos($arrData['pagecontactfields'], "country"))) {
					$GLOBALS['IsContactCountry'] = 'checked="checked"';
				}
				
				if(is_numeric(isc_strpos($arrData['pagecontactfields'], "city"))) {
					$GLOBALS['IsContactCity'] = 'checked="checked"';
				}
				
				if(is_numeric(isc_strpos($arrData['pagecontactfields'], "zip"))) {
					$GLOBALS['IsContactZip'] = 'checked="checked"';
				}
				
				if(is_numeric(isc_strpos($arrData['pagecontactfields'], "birthday"))) {
					$GLOBALS['IsContactBirthday'] = 'checked="checked"';
				}
