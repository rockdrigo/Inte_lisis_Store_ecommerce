			  ...
			  <table class="Panel">
				...
				<tr class="HideIfContact">
					...
					<td>
						...
						<input type="checkbox" id="contactfield7" name="contactfields[rma]" value="rma" {{ IsContactRMA|safe }}> <label for="contactfield7">{% lang 'ContactRMANo' %}</label><br />
						<input type="checkbox" id="contactfield8" name="contactfields[names]" value="names" {{ IsContactNames|safe }}><label for="contactfield8">{% lang 'ContactNames' %}</label><br />
						<input type="checkbox" id="contactfield9" name="contactfields[lastname]" value="lastname" {{ IsContactLastName|safe }}><label for="contactfield9">{% lang 'ContactLastName' %}</label><br />
						<input type="checkbox" id="contactfield10" name="contactfields[address]" value="address" {{ IsContactAddress|safe }}><label for="contactfield10">{% lang 'ContactAddress' %}</label><br />
						<input type="checkbox" id="contactfield11" name="contactfields[colony]" value="colony" {{ IsContactColony|safe }}><label for="contactfield11">{% lang 'ContactColony' %}</label><br />
						<input type="checkbox" id="contactfield12" name="contactfields[country]" value="country" {{ IsContactCountry|safe }}><label for="contactfield12">{% lang 'ContactCountry' %}</label><br />
						<input type="checkbox" id="contactfield13" name="contactfields[city]" value="city" {{ IsContactCity|safe }}><label for="contactfield13">{% lang 'ContactCity' %}</label><br />
						<input type="checkbox" id="contactfield14" name="contactfields[zip]" value="zip" {{ IsContactZip|safe }}><label for="contactfield14">{% lang 'ContactZip' %}</label><br />
						<input type="checkbox" id="contactfield15" name="contactfields[birthday]" value="birthday" {{ IsContactBirthday|safe }}><label for="contactfield15">{% lang 'ContactBirthday' %}</label>
				...
				<tr>
					...
					<td>
						...
						<select name="pagecustomersonly" id="pagecustomersonly">
							<option value="0" {{ PageCustomerOnlySelected0 }}>No</option>
							<option value="1" {{ PageCustomerOnlySelected1 }}>Si, todos los usuarios registrados</option>
							<option value="2" {{ PageCustomerOnlySelected2 }}>Si, elegir por grupos de usuarios</option>
						</select>
