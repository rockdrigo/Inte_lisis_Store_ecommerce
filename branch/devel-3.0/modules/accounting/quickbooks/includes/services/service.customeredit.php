...
class ACCOUNTING_QUICKBOOKS_SERVICE_CUSTOMEREDIT extends ACCOUNTING_QUICKBOOKS_SERVICE_BASE
{
	...
	{
		$this->accounting->unsetReference("customer", '', '', $this->spool["nodeId"]);
		return $this->execChildService("customer", "add", $this->spool["nodeData"]);
	}
