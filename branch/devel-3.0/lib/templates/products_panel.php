...
class PRODUCTS_PANEL extends PANEL
{
	...
	public function setProductGlobals($row)
	{
		...
		/* NES - Quito esto porque no se puede recalcular cada uno bajo demanda, lo voy a hacer con un procedimiento manual o periodico
		if(GetConfig('isIntelisis'))
		{
			...
			if($saleprice != '') {
				...
				$row['prodcalculatedprice'] = applyPyC($row); //Precio a mostrar en la lista, regresado por PyC
