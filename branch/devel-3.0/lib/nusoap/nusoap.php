	...
	*/
	function serializeSchema(){
		...
		foreach($this->complexTypes as $typeName => $attrs){
			...
			if(isset($attrs['elements']) && (!empty($attrs['elements']))){
			...
			if (isset($attrs['restrictionBase']) && $attrs['restrictionBase'] != ''){
				...
				if ((isset($attrs['elements']) && !empty($attrs['elements'])) || (isset($attrs['attrs']) && !empty($attrs['attrs']))){
		...
		// simple types
		if(isset($this->simpleTypes) && !empty($this->simpleTypes)){
