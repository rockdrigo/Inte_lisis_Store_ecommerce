...
CALL spAlterTable('%%PREFIX%%intelisis_customers', 'Sucursal', 'int(11) NULL DEFAULT NULL');
...
COLLATE utf8_general_ci ENGINE=InnoDB;
CALL spAddIndex('%%PREFIX%%intelisis_products', 'Articulo');
...
CREATE TABLE IF NOT EXISTS `%%PREFIX%%intelisis_configurable_fields` (
	...
	`OpcionIntelisis` CHAR(1) NULL,
	PRIMARY KEY (`IDCampo`, `productfieldid`)
)
COLLATE utf8_general_ci ENGINE=InnoDB;

CALL spAlterTable('%%PREFIX%%intelisis_configurable_fields', 'OpcionIntelisis', 'CHAR(1) NULL DEFAULT NULL AFTER `productfieldid`');

CREATE TABLE IF NOT EXISTS `%%PREFIX%%intelisis_configurable_fields_detail` (
	`ID` INT(10) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `%%PREFIX%%intelisis_order_status` (
	...
	`EsCompleto` bit NULL DEFAULT 0
)
COLLATE='utf8_general_ci' ENGINE=InnoDB;

CALL spAlterTable('%%PREFIX%%intelisis_order_status', 'EsCompleto', 'bit NULL DEFAULT 0 AFTER `IDWebSituacion`');
...
CALL spAlterTable('%%PREFIX%%intelisis_ListaPreciosD', 'Precio', 'FLOAT NULL DEFAULT NULL AFTER `Articulo`');
CALL spAlterTable('%%PREFIX%%intelisis_ListaPreciosD', 'Margen', 'FLOAT NULL DEFAULT NULL AFTER `CodigoCliente`');
...
CALL spAlterTable('%%PREFIX%%intelisis_ListaPreciosDUnidad', 'Precio', 'FLOAT NULL DEFAULT NULL AFTER `Unidad`');
...
CALL spAlterTable('%%PREFIX%%intelisis_ListaPreciosSub', 'Precio', 'FLOAT NULL DEFAULT NULL AFTER `SubCuenta`');
...
CALL spAlterTable('%%PREFIX%%intelisis_ListaPreciosSubUnidad', 'Precio', 'FLOAT NULL DEFAULT NULL AFTER `Unidad`');
...
CREATE TABLE IF NOT EXISTS `%%PREFIX%%intelisis_Sucursal`(
	...
	`eCommerceConsultaExistencias` SMALLINT(1) NULL DEFAULT '0',
...
CALL spAlterTable('%%PREFIX%%intelisis_Sucursal', 'eCommerceVentaEmpresa', 'VARCHAR(5) NULL AFTER `eCommerceURL`');
CALL spAlterTable('%%PREFIX%%intelisis_Sucursal', 'AlmacenPrincipal', 'char(10) NULL AFTER `Telefonos`');
...
CALL spAlterTable('%%PREFIX%%intelisis_inv', 'Fecha', 'INT(11) NOT NULL AFTER `Existencia`');
...
CREATE TABLE IF NOT EXISTS `%%PREFIX%%intelisis_gift_wrapping` (
	`IDEnvoltura` INT(11) NOT NULL,
	`wrapid` INT(11) NOT NULL,
	PRIMARY KEY (`IDEnvoltura`)
)
COLLATE='latin1_swedish_ci'
ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `%%PREFIX%%intelisis_product_offers` (
	`productid` INT(11) NOT NULL,
    `origprice` decimal(20,4) NOT NULL default '0',
	`newprice` decimal(20,4) NOT NULL default '0',
	PRIMARY KEY (`productid`)
)
ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE utf8_general_ci;
