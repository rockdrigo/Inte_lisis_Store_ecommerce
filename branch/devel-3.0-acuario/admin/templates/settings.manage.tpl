...
<tr>
			...
			<div id="div2" style="padding-top: 10px;">
				...
				<table width="100%" class="Panel">
					...
					<tr>
						<td class="FieldLabel">
							&nbsp;&nbsp; <label for="ShowCartSuggestions">Ver Imagen de la Marca?</label>
						</td>
						<td class="PanelBottom">
							<input type="checkbox" name="ShowProductBrandImage" id="ShowProductBrandImage" value="ON" {{ ShowProductBrandImageChecked|safe }} /> <label for="ShowProductBrandImage">Si, mostrar la imagen de la marca en mi tienda.</label>
						</td>
					</tr>
					<tr>
						<td class="FieldLabel">
