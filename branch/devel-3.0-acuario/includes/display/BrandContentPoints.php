		...
		public function SetPanelSettings()
		{
			...
			if($GLOBALS['ISC_CLASS_BRANDS']->GetNumProducts() > GetConfig('CategoryProductsPerPage')) {
				...
				if($GLOBALS['ISC_CLASS_BRANDS']->GetPage() > 1) {
					...
					$GLOBALS['FirstLink'] = BrandLink($GLOBALS['ISC_CLASS_BRANDS']->GetBrandName(), array('page' => $start, 'sort' => $GLOBALS['ISC_CLASS_BRANDS']->GetSort()));
				...
				if($GLOBALS['ISC_CLASS_BRANDS']->GetPage() < $GLOBALS['ISC_CLASS_BRANDS']->GetNumPages()) {
					...
					$GLOBALS['LastLink'] = BrandLink($GLOBALS['ISC_CLASS_BRANDS']->GetBrandName(), array('page' => $GLOBALS['ISC_CLASS_BRANDS']->GetNumPages(), 'sort' => $GLOBALS['ISC_CLASS_BRANDS']->GetSort()));
