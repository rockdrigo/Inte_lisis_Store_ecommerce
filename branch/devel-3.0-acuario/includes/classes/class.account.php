		...
		private function EditAccount($MessageText = "", $MessageStatus = -1)
		{
			...
			if (!empty($customer_details)) {
				...
				foreach (array_keys($fields) as $fieldId) {
					...
					if ($fields[$fieldId]->record['formfieldlabel'] == GetLang('StoreDeliveryLabel')) {
						$fields[$fieldId]->setOptionIndexAsValues(true);
						$fields[$fieldId]->setOptions(array_values(getStoreDeliveryOptions()));
					}
